#HA-CLA-I Individual Contributor License Agreement

Thank you for your interest in contributing to Materials Innovation Network ("We", "Us" or "MatIN").

This contributor agreement ("Agreement") documents the rights granted by contributors to Us. To make this document effective, please sign it and send it to Us by mail, email, fax, or electronic submission, following the instructions at https://github.com/Materials-Innovation-Network/matin/blob/master/README.md. This is a legally binding document, so please read it carefully before agreeing to it. The Agreement may cover more than one software project managed by Us.
...
In addition, We may use the following licenses for Media in the Contribution: Creative Commons (including any right to adopt any future version of a license if permitted).
